...
We take four different approaches to analyze the survival data.

1. A linear model that excludes all censored observations from the analysis
2. A linear model but treats all censored times as death times
3. A logistic regression, where the binary outcome is either death, or censorship
4. A log-linear Weibull regression that addresses the censoring nature of the survival data in the likelihood
